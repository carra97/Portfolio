...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: { canonical: `/${lang}/proyectos/${slug}` },
    openGraph: {
      type: 'article',
      title: study.title,
      description: study.summary,
      url: `/${lang}/proyectos/${slug}`,
    },
  };
}
  ...
  return (
    <div className="mx-auto max-w-[1120px] px-6 md:px-10">
      <div className="max-w-[68ch]">
        <nav aria-label="Miga de pan" className="py-8">
          <a className="prose-link font-mono text-xs uppercase tracking-[0.12em]" href={`/${lang}#proyectos`}>
        ...
        <Block title="Qué haría distinto hoy">
        ...
        <div className="border-t border-line py-12">
          <a
            ...
            href={`/${lang}#contacto`}
          >
            {profile.ui.contactWhatsApp.replace('por WhatsApp', 'sobre este proyecto')}
          </a>
        </div>
      </div>
    </div>
